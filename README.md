...
* **2024.10.26-2024.10.30**: I've updated two demos, mainly regarding the implementation of GAN and WGAN. You can refer to the files [GAN.py](./DEMO/GAN.py) and [WGAN.py](./DEMO/WGAN_GP.py). The next step is to use GAN for fault classification.
...
* GAN Applications in Falut Diagnosis: [GAN](./md/GAN.md)
