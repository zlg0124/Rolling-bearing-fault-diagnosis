...
def train(model, model_z2g, discriminator, D_Graph, optimizers, data, device):
    ...
    # DPP 
    # z_real_dist = distribution.sample(adj_dense.shape[0]) # 2708, 128
...
if __name__ == '__main__':
    ...
    total_loss = train(model, model_z2g, discriminator, D_Graph, optimizers, feas, device)
    print(total_loss)
